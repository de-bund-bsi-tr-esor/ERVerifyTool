...
public class TestBasisErsEvidenceRecordValidator extends TestEvidenceRecordValidator
{
    ...
    public void validBasisErs() throws Exception
    {
        ...
        assertThat("BASIS-ERS validation", validateAgainstBasisErs(er).getOverallResult().getResultMajor(), endsWith(":valid"));

        assertThat("RFC4998 validation", validateAgainstRfc4998(er).getOverallResult().getResultMajor(), endsWith(":valid"));
    }
    ...
    public void invalidRfc4998() throws Exception
    {
        ...
        assertThat("RFC4998 validation", validateAgainstRfc4998(er).getOverallResult().getResultMajor(), endsWith(":invalid"));
    }
    ...
    {
        basisErsValidator.setContext(new ErValidationContext(reference,
            er,
    ...
    {
        rfc4998Validator.setContext(new ErValidationContext(reference,
            er,
