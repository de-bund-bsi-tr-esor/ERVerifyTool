...
public class TestLXaipReader
{
  ...
  public void throwsOnIncompleteLXaip()
  {
    ...
    var actual = assertThrows(LXaipUnprocessableException.class,
                              () -> sut.isValidLXaipElement(dataObject, dataObject.getDataObjectID()));
    assertThat(actual.getMessage(),
               is("Detected a LXAIP but its data object reference (id: some-id) is incomplete"));
  }
  ...
  public void getsBinaryData()
  {
    ...
    assertThat(new String(actual, StandardCharsets.UTF_8),
               is("Dies ist ein Testdokument mit qualifizierter Signatur.\n"));
  }
  ...
  public void throwsOnNotAllowedUri()
  {
    for ( var notAllowed : List.of("../some-file.txt", "some-dir/../../some-file.txt") )
    {
      ...
      var actual = assertThrows(LXaipUnprocessableException.class,
                                () -> sut.readBinaryData(dataObject, dataObject.getDataObjectID()));
  ...
  public void throwsOnWrongDigestValue()
  {
    ...
    var actual = assertThrows(LXaipDigestMismatchException.class,
                              () -> sut.readBinaryData(dataObject, dataObject.getDataObjectID()));
    assertThat(actual.getMessage(),
  ...
  public void throwsOnUnknownDigestMethod()
  {
    ...
    var actual = assertThrows(LXaipUnprocessableException.class,
                              () -> sut.readBinaryData(dataObject, dataObject.getDataObjectID()));
    assertThat(actual.getMessage(),
               is("The LXAIP digest method of the data object reference (id: some-id) is unknown"));
  }
  ...
  public void throwsExceptionIfLXaipsDataObjectFileNotFound()
  {
    ...
    assertThat(actual.getMessage(),
               containsString("Cannot read LXAIP's data object (id: some-id) from file"));
