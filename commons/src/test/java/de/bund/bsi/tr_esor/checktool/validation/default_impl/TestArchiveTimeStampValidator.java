...
public class TestArchiveTimeStampValidator
{
  ...
  /**
   * Asserts that in the HashSortingMode.BOTH the correct hashes can be present in the DigestsToCover both as
   * primary and as alternative hashes.
   */
  @Test
  ...
  /**
   * Asserts that in the HashSortingMode.UNSORTED when the correct (sorted) hashes are present as alternative
   * hashes in the DigestsToCover, a clear message is generated.
   */
  @Test
  ...
  /**
   * Asserts that in the HashSortingMode.SORTD when the correct (sorted) hashes are present as primard hashes
   * in the DigestsToCover, no warning is generated.
   */
  @Test
