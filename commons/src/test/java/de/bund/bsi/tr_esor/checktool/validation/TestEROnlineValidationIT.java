...
/**
 * Tests for the timestamp online verification done by the ECardTimestampValidator. This requires a chain of
 * validators to work together, so these tests must be applied to an early entrypoint of the overall
 * validation and cannot be tested in isolation of the ECardTimestampValidator.
 */
