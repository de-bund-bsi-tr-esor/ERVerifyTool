...
public final class ParserFactory
{
    ...
    /**
     * Parses given input by trying all parsers of the specified profile and returns the result of the first parser which can parse the
     * input.
     */
    ...
    /**
     * Returns all configured parsers which are available for a given profile name and all predefined parsers. Parsers which have been
     * configured come first.
     */
