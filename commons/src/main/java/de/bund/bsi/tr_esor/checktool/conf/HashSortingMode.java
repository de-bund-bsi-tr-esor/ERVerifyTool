...
/**
 * Mode for sorting hash values after a rehash. This is needed as different TR implementations interpret the evidence record standard in a
 * different way. The verbatim interpretation of RFC4998 for ASN.1-based ERs is used as a default here and proposes that hashes must not be
 * sorted during a rehash.
 */
public enum HashSortingMode
{
    ...
    public static HashSortingMode fromString(String sortingMode)
    {
        ...
        switch (configuredMode)
        {
            ...
            default:
                LOG.warn(
                    "Cannot understand mode {} for hash sorting. Valid values are unsorted, sorted and both. Using default hash mode \"unsorted\".",
                    sortingMode);
