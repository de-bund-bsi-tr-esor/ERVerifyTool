...
/**
 * Helper class for handling XML requests and responses. Note that due to the many "xs:any"- elements in the
 * schemas JAXB parsing will not create the needed objects in a single run.
 *
 * @author TT
 */
public final class XmlHelper
{
   ...
   */
  public static final oasis.names.tc.dss._1_0.core.schema.ObjectFactory FACTORY_DSS = new oasis.names.tc.dss._1_0.core.schema.ObjectFactory();
   ...
   */
  public static final oasis.names.tc.dss_x._1_0.profiles.verificationreport.schema_.ObjectFactory FACTORY_OASIS_VR = new oasis.names.tc.dss_x._1_0.profiles.verificationreport.schema_.ObjectFactory();

  /**
   * Object factory for name space used by OCSP identifiers, Name space URI is
  ...
  /**
   * Converts a verification report into a DOM element which can be digested by the WS stack. Note that the
   * web service declares lots of xs:any elements and does not know about contained types.
   *
   * @param report
   * @throws JAXBException
   */
  public static Element toElement(VerificationReportType report) throws JAXBException
  {
    return toElement(report,
                     ...
                     FACTORY_OASIS_VR::createVerificationReport);
  }
