...
/**
 * Possible major result values for element {@code<Result>} from
...
public enum OasisDssResultMajor
{
   ...
   * <p>
   * In case of doubt of who is responsible a urn:oasis:names:tc:dss:1.0:resultmajor:ResponderError is
   * assumed.
   * </p>
   */
